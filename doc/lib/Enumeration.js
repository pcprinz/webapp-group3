 ...
 * @constructor
 * @param {string[] | {[key: string]: string}} enumArg  The labels of the new enumeration literals.
 */
export function Enumeration(enumArg) {
  if (Array.isArray(enumArg)) {
    ...
    if (
      !Object.keys(enumArg).every((code) => typeof enumArg[code] === "string")
    ) {
      throw new ConstraintViolation(
 ...
 * @param {number[]} a the list of indizes
 * @returns {string} the stringified Enumeration
 */
